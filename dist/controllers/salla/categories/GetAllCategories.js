...
exports.GetAllCategories = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const categories = yield axios_1.default.request(categoriesFetch);
    let categoriesData = categories.data.data.map((category) => { let { id, name } = category; return { name, id }; });
    res.status(200).json({
        status: "success",
        data: categoriesData,
    });
